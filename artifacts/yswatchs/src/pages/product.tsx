            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                <motion.div
                  ...
                  className="aspect-square watch-display flex items-center justify-center p-10 sm:p-14 relative overflow-hidden"
                  style={{
                    userSelect: "none",
                ...
                >
                  ...
                  <button
                    onClick={toggleZoom}
                    title={zoomed ? "Fermer le zoom" : "Zoomer sur l'image"}
                    className="absolute bottom-4 right-4 flex items-center gap-1.5 transition-all duration-200 hover:opacity-80 active:scale-95"
                    style={{
                      background: zoomed ? "var(--ys-gold)" : "var(--ys-surface)",
                      border: `1px solid ${zoomed ? "var(--ys-gold)" : "var(--ys-border)"}`,
                      padding: "6px 12px",
                      fontSize: "0.6rem",
                      letterSpacing: "0.25em",
                      textTransform: "uppercase",
                      color: zoomed ? "var(--ys-bg)" : "var(--ys-text-muted)",
                ...
                {zoomed && (
                  <p style={{ fontSize: "0.6rem", color: "var(--ys-text-muted)", letterSpacing: "0.2em", textAlign: "center", marginTop: "0.5rem", fontFamily: "'Jost', sans-serif", textTransform: "uppercase" }}>
                    Déplacez le curseur pour explorer l'image
                  </p>
                )}
              </div>
            </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-4 mb-8 p-5"
                ...
                {[
                  ...
                  { label: "Boîtier", value: product.caseMaterial ? matLabels[product.caseMaterial] || product.caseMaterial : "Acier 316L" },
