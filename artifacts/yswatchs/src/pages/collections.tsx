...
export default function CollectionsPage() {
  ...
  return (
    <div style={{ background: 'var(--ys-bg)', color: 'var(--ys-text)', minHeight: '100vh', transition: 'background 0.45s, color 0.45s' }}>
      ...
      {/* Header */}
      <div className="relative pt-28 sm:pt-32 pb-12 px-6 overflow-hidden"
        ...
        <div className="h-[2px] absolute top-0 left-0 right-0"
          style={{ background: 'linear-gradient(to right, transparent, var(--ys-gold), transparent)', opacity: 0.45 }} />
        <div className="absolute bottom-4 left-8 hidden sm:block"
          style={{ width: '24px', height: '24px', borderLeft: '1px solid var(--ys-border)', borderBottom: '1px solid var(--ys-border)' }} />
        <div className="absolute bottom-4 right-8 hidden sm:block"
          style={{ width: '24px', height: '24px', borderRight: '1px solid var(--ys-border)', borderBottom: '1px solid var(--ys-border)' }} />
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="label-victorian mb-4">
            ✦ &nbsp; Nos Créations &nbsp; ✦
          </motion.p>
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}
            style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(2.5rem, 7vw, 5.5rem)', fontWeight: 300, letterSpacing: '0.04em', marginBottom: '0.75rem', color: 'var(--ys-text)' }}>
            Toutes les <em className="gold-text" style={{ fontStyle: 'italic' }}>Collections</em>
          </motion.h1>
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}
            style={{ fontSize: '0.65rem', color: 'var(--ys-text-muted)', letterSpacing: '0.3em', textTransform: 'uppercase', fontFamily: "'Jost', sans-serif" }}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-10 sm:mb-14">
            <div>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(2rem, 5vw, 3.2rem)', fontWeight: 300, letterSpacing: '0.04em', color: 'var(--ys-text)' }}>
                Horlogerie <em className="gold-text" style={{ fontStyle: 'italic' }}>Masculine</em>
              </h2>
            </div>
            <Link href="/montres/homme"
              className="hidden sm:flex items-center gap-2 hover:text-[var(--ys-gold)] transition-colors"
              style={{ fontSize: '0.6rem', letterSpacing: '0.3em', textTransform: 'uppercase', color: 'var(--ys-text-muted)', borderBottom: '1px solid var(--ys-border)', paddingBottom: '2px' }}>
              Explorer tout
            </Link>
          </div>
                        ...
                        <div className="absolute top-2 left-2 flex flex-col gap-1">
                          ...
                          {product.isNew && (
                            <span className="text-[6px] tracking-[0.15em] uppercase px-1.5 py-0.5"
                              style={{ background: 'var(--ys-surface-2)', color: 'var(--ys-gold)', border: '1px solid var(--ys-border)' }}>New</span>
                          )}
                        </div>
                      </div>
                      <div className="p-3 sm:p-4" style={{ borderTop: '1px solid var(--ys-border)' }}>
                        <h3 className="group-hover:text-[var(--ys-gold)] transition-colors mb-2 line-clamp-1"
                          style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1rem', fontWeight: 400, letterSpacing: '0.02em', color: 'var(--ys-text)' }}>
                          {product.name}
                        </h3>
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          {disc && (
                            <span style={{ fontSize: '0.68rem', color: 'var(--ys-text-dim)', textDecoration: 'line-through' }}>
      ...
      <section className="pb-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            style={{ border: '1px solid var(--ys-border)', background: 'var(--ys-surface)', transition: 'background 0.45s' }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(1.8rem, 4vw, 3rem)', fontWeight: 300, letterSpacing: '0.04em', marginBottom: '1rem', color: 'var(--ys-text)' }}>
              Horlogerie <em className="gold-text" style={{ fontStyle: 'italic' }}>Féminine</em>
            </h2>
            <p style={{ fontSize: '0.75rem', color: 'var(--ys-text-muted)', letterSpacing: '0.15em', lineHeight: 1.8, maxWidth: '420px', margin: '0 auto 2rem', fontFamily: "'Jost', sans-serif" }}>
